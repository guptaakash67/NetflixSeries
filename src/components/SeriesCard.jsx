...
export const SeriesCard = (props)=>{
  ...
  const ratingClass = rating >= 8.5 ? "super_hit" : "average";
      ...
      <h3 style={{color:"#7dcea0"}}>Rating no: <span className={ratingClass} >
      {rating}</span></h3>  

       <summary style={{margin:"1.2rem 0"}} className="text-3xl font-bold underline text-cyan-300">Summary:{summary} </summary>
       <p>Genre:{genre}</p>
       <p>Cast:{cast}</p>
